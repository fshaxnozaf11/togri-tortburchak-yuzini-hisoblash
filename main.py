...
class TogritortburchakyuzinihisoblashProcessor:
    """
    Auto-generated handler for: "To'g'ri to'rtburchak yuzini hisoblash.",
    """
    def __init__(self):
    ...
    def get_summary(self):
        return {
            "handler": "TogritortburchakyuzinihisoblashProcessor",
...
def main():
    print("=" * 50)
    print("🚀 Initializing module for: "To'g'ri to'rtburchak yuzini hisoblash.",")
    print("=" * 50)
    
    processor = TogritortburchakyuzinihisoblashProcessor()
